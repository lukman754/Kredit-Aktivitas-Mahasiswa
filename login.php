...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Sanitasi input (meskipun password dan NIM biasanya tidak berisikan HTML, tetap lakukan sanitasi untuk menjaga keamanan)
    $nim = htmlspecialchars(trim($_POST['nim']));
    $password = $_POST['password'];  // Password tidak perlu disanitasi dengan htmlspecialchars karena password tidak diekspresikan dalam HTML

    // Validasi NIM hanya berisi angka
    if (!is_numeric($nim)) {
        $error = "NIM harus berisi angka!";
    } else {
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4 text-muted small">Teruslah berkarya, karena setiap langkah kecil Anda membawa
                            perubahan besar!</p>
                        <?php if (isset($error)): ?>
