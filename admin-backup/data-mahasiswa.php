                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)):
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="badge bg-success">+<?= $activity_points ?> poin</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-danger"><?= $row['total_violations'] ?></span>
                                                        <span class="badge bg-danger">-<?= $violation_points ?> poin</span>
                                                    </td>
                                                    <td>
